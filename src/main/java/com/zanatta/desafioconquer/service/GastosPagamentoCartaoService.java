...
/**
 * Service com as regras de negócio para gastos de pagamento com cartão
 * @author <a href="mailto:jean.zanatta@unoesc.edu.br">Jean Luiz Zanatta</a>
 * @since 09/07/2021
 */
@Service
public class GastosPagamentoCartaoService {

	@Autowired private GastoPorEstabelecimentoService gastoPorEstabelecimentoService;
	@Autowired private PortalTransparenciaGovRest apiRest;
	@Autowired private MessageUtil messageUtil;

	@Transactional(propagation = Propagation.NEVER)
	public List<GastoPorEstabelecimento> saveGastoPorEstabelecimento(final GastosPagamentoCartaoParamVO paramVO) throws ApiDadosCartoesException {
		...
		this.gastoPorEstabelecimentoService.saveGastoPorEstabelecimento(param, dadosPersistencia);
