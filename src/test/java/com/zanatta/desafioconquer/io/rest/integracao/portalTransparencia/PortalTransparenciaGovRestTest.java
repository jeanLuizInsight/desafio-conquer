...
public class PortalTransparenciaGovRestTest {
	...
	// @Test
	public void deveBuscarGastosPorMeioDeCartaoDePagamentoParaUmIntervaloDeMeses() throws JsonProcessingException, URISyntaxException {
		// cenário
		...
		mockServer.expect(ExpectedCount.once(), MockRestRequestMatchers.requestTo(builder.toUriString()))
				.andExpect(MockRestRequestMatchers.method(HttpMethod.GET))
				.andRespond(MockRestResponseCreators.withStatus(HttpStatus.OK)
						.contentType(MediaType.APPLICATION_JSON)
						.body(mapper.writeValueAsString(transacaoList)));

		// ação
		final List<TransacaoDTO> retorno = api.getGastosPorMeioDeCartaoDePagamento(vo);
